...
public class MemoryGraphic {
    ...
    public void drawGraphic (Graphics graphics) {
        ...
        g.drawOval(2, 80, 13, 13);
        
        if (!memoryStats.isWindows()) {
	        // Draw inactive memory circle
	        g.setColor(BLUE);
	        g.fillOval(2, 100, 13, 13);
	        g.setColor(Color.BLACK);
	        ...
	        g.drawOval(2, 100, 13, 13);
        }
        
        // Draw used memory circle
        g.setColor(YELLOW);
        g.fillOval(2, 120, 13, 13);
        g.setColor(Color.BLACK);
